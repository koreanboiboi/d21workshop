...
public class Queries {
    ...
    public static final String SQL_GET_ALL_CUSTOMERS = "select id, company, last_name, first_name from customers limit ? offset ?";

    public static final String SQL_SELECT_CUSTOMER_BY_ID = "select id, company, last_name, first_name from customers where id = ?";
